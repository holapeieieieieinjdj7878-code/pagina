...
<head>
  ...
  <title>Agencia de Diseño Web – viewport</title>
  <style>
    :root {
      --bg: #0f172a;         
      --panel: #111827ee;    
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    body {
      ...
      background: radial-gradient(1200px 800px at 20% -10%, #1f2937 0%, transparent 60%),
                  radial-gradient(1000px 600px at 120% 10%, #0b1022 0%, transparent 60%),
                  linear-gradient(180deg, #0b1022 0%, #0f172a 40%, #0b1022 100%);
      color: var(--text);
      line-height: 1.6;
      overflow-x: hidden;
    }
    ...
    .container {
      max-width: 1100px;
      margin: 0 auto;
      padding: 24px;iugucyfx
    }

    header {
      position: sticky; top: 0; z-index: 20;
      backdrop-filter: blur(10px);
      background: linear-gradient(180deg, rgba(17,24,39,.75), rgba(17,24,39,.35));
  ...
  <main class="container">
    ...
    <section class="tabs" aria-live="polite">
      ...
      <article id="tab-proyectos" class="panel" role="tabpanel">
        ...
        <h2>6. Seguridad y Mantenimiento</h2>
        <ul>
